...
public class BlocksugarBeetBlock extends BlockFlower
{
    protected BlocksugarBeetBlock(int par1, int par2)
    {
        super(par1, par2);
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        ...
        for (int j = 0; j < i; j++)
        {
                ...
                EntityItem entityitem = new EntityItem(par1World, (float)par2 + f1, (float)par3 + f2, (float)par4 + f3, new ItemStack(MoltenCoreMain.sugarBeetRoot));
    ...
    {
        return MoltenCoreMain.sugarBeetRoot.itemID;
    }
